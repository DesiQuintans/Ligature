...
// HEY! Do you want to add your own shortcuts? Just copy/paste and existing edButtons.push command and edit it.
// It is in the format, edButton('HOVER TIP', 'BUTTON LABEL', 'OPENING COMMAND', 'CLOSING COMMAND', QUICK KEY')
// If you don't want to give your button the ability to wrap its command around highlighted blocks of text,
// then only fill out the Opening Command and leave the Closing Command empty (that is two apostrophes with nothing between them: '').
...
edButtons.push(
   new edButton('Hide From Parser','Hide From Parser','(!)))','(!)))','E')
);
