...
if($_POST['reset']) {
    ...
    if($u) {
        ...
        if(mysql_num_rows($getinfo) != 1) {
            ...
            $email_body = 'Your password to log into Ligature has been changed to "'.$p.'". Once you are
            logged in you can change your password to something more familiar.';
            $emailed = mail($info['Email'], 'Ligature Password', $email_body);
        }
    }
...
?>
<p>
Enter your username to reset your password. The new password will be sent to the email address you supplied.
</p>
